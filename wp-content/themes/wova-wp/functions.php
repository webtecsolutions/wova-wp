...
function theme_name_register_theme_customizer($wp_customize)
{
	...
	$wp_customize->add_setting(
		...
		array(
			'default' => __('MADE LIVELIER.', 'theme-name'),
			'sanitize_callback' => 'sanitize_text'
		)
	);
	$wp_customize->add_control(
	...
	$wp_customize->add_control(
		new WP_Customize_Control(
			...
			array(
				'label' => __('Second Section Heading Two', 'theme_name'),
				'section' => 'second_section',
				'settings' => 'second_section_heading_twoo',
				'type' => 'text'
			)
		)
	);
	...
	$wp_customize->add_setting(
		...
		array(
			'default' => __('FINAL RELEASE NOW SELLING.', 'theme-name'),
			'sanitize_callback' => 'sanitize_text'
		)
	);
	$wp_customize->add_control(
	...
	$wp_customize->add_setting(
		...
		array(
			'default' => __('REGISTER YOUR INTEREST TODAY.', 'theme-name'),
			'sanitize_callback' => 'sanitize_text'
		)
	);
	$wp_customize->add_control(
