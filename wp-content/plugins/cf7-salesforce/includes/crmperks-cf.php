...
?>
  <div class="vx_div">
        <div class="vx_head">
<div class="crm_head_div"><i class="fa fa-bullhorn"></i> <?php esc_html_e('Marketing Data', 'cf7-salesforce'); ?></div>
...
<p><?php esc_html_e('Need Marketing Insight? ,','cf7-salesforce')?> <a href="<?php echo esc_url($plugin_url) ?>&section=vxc_premium"><?php esc_html_e('Go Pro!','cf7-salesforce')?></a></p>
</div>
 <?php
 }else{
...
if(!$html_added){
   ?> 
   <h3 style="text-align: center;"><?php esc_html_e('No Information Available','cf7-salesforce')?></h3>
   <?php
}
 }
?>
