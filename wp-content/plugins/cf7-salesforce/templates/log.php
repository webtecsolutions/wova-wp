...
<div class="crm_head_div"><span class="crm_head_text"><?php esc_html_e('Data Sent','cf7-salesforce') ?></span></div>
...
<?php
      ...
      ?>
  <div class="vx_error"><i class="fa fa-warning"></i> <?php esc_html_e('Nothing Posted to Salesforce','cf7-salesforce');?></div>      
      <?php
  }
?>
</div></div>
    ...
    if(is_array($response) && count($response)>0){
      ...
      ?>
        <div class="crm_panel crm_panel_50">
<div class="crm_panel_head">
<div class="crm_head_div"><span class="crm_head_text"><?php esc_html_e('Salesforce Response','cf7-salesforce') ?></span></div>
<div class="crm_btn_div" title="<?php esc_html_e('Expand / Collapse','cf7-salesforce'); ?>"><i class="fa crm_toggle_btn fa-minus"></i></div>
<div class="crm_clear"></div>
</div>
<div class="crm_panel_content crm-block-content">
...
<div class="crm_panel_head">
<div class="crm_head_div"><span class="crm_head_text"><?php esc_html_e('More Detail','cf7-salesforce') ?></span></div>
<div class="crm_btn_div" title="<?php esc_html_e('Expand / Collapse','cf7-salesforce'); ?>"><i class="fa crm_toggle_btn fa-minus"></i></div>
<div class="crm_clear"></div>
</div>
<div class="crm_panel_content crm-block-content">
...
?>
 ...
 if($error){
  ?>
<div class="vx_error"><i class="fa fa-warning"></i> <?php esc_html_e('Detail Not Found','cf7-salesforce');?></div>  
  <?php   
 } ?>
...
?>
<a href="<?php echo esc_url($feed_link) ?>" title="<?php esc_html_e('Edit Feed','cf7-salesforce') ?>" class="button"><i class="fa fa-edit"></i> <?php esc_html_e('Edit Feed','cf7-salesforce') ?></a>
<?php
    }
?>
<a href="<?php echo esc_url($log_link) ?>" title="<?php esc_html_e('Open in New Window','cf7-salesforce') ?>" target="_blank" class="button"><i class="fa fa-external-link"></i> <?php esc_html_e('Open in New Window','cf7-salesforce') ?></a>
<a href="#" class="button vx_close_detail" title="<?php esc_html_e('Close','cf7-salesforce') ?>"><i class="fa fa-times"></i> <?php esc_html_e('Close','cf7-salesforce') ?></a>
